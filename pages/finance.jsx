...
const DICT = {
  en: { dashTitle: 'Finance & Invoices', dashSub: 'Manage your active escrows, project milestones, and payout history.', lblEscrow: 'Funds in Escrow', lblReleased: 'Total Released', lblPending: 'Active Projects', thProject: 'Project / Order ID', thCounterparty: 'Counterparty', thAmount: 'Total Amount', thStatus: 'Status', thAction: 'Action', modalTitle: 'Project Milestones', btnModalClose: 'Close', signIn: 'Sign In', createAccount: 'Create Account', lblName: 'Full Name', lblRole: 'I am a...', lblEmail: 'Email Address', lblPassword: 'Password', lblOr: 'or continue with', btnLogin: 'Sign In to Dashboard', btnCreate: 'Create Account', logout: 'Sign Out', recAiScore: 'AI Screening', recUnverified: 'Unverified', recReviews: 'reviews', recNoReviews: 'No reviews yet', availAvailable: 'Available', availBusy: 'Busy', availUnavailable: 'Unavailable', offlineBannerPrefix: 'Offline · data as of', offlineFundsPaused: 'fund actions paused', offlineNoFundsAction: 'Funds actions unavailable while offline' },
