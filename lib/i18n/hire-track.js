...
const DICT = {
  ...
  fr: {
    ...
    verifyIntro:
      'Chaque ingénieur réussit une évaluation technique pratique par IA avant de pouvoir être mis en relation. En complément, il peut obtenir la certification dans cette spécialité à trois niveaux — et seuls les ingénieurs certifiés peuvent être affectés à votre projet.',
