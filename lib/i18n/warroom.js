// ── /warroom 页九语 UI 字典（lib/i18n 架构 B，模块风格照抄 lib/i18n/rates.js）──
// 来源：pages/warroom.jsx 内联 DICT，2026-07-24 逐字节原样搬移（机械搬家，文案零改动）。
const DICT = {
  en: {
  ...
  zh: {
    pageTitle:      'Babel War Room',
    headerSub:      'Babel War Room™ — 实时 AI 翻译',
    enterTitle:     '进入 War Room',
    labelProjectId: '项目编号',
    labelRole:      '我的身份…',
    optEmployer:    '甲方（中文沟通）',
    ...
    send:           '发送',
    uploadTitle:    '上传施工证明',
    welcomeMsg:     '欢迎进入 Babel War Room。所有消息将被实时翻译。',
  ...
  es: {
    pageTitle:      'Babel War Room',
    headerSub:      'Babel War Room™ — Traducción IA en tiempo real',
    enterTitle:     'Entrar al War Room',
    ...
    welcomeMsg:     'Bienvenido al Babel War Room. Todos los mensajes se traducen en tiempo real.',
    joinedMsg:      (name, role) => `Se unió al canal como ${name} (${role})`,
    placeholderEmployer: '请输入中文…',
    placeholderEngineer: 'Escriba su mensaje en español…',
    labelMe:        'Yo',
    labelTrans:     'Trad.',
  ...
  vi: {
    pageTitle:      'Babel War Room',
    headerSub:      'Babel War Room™ — Dịch thuật AI theo thời gian thực',
    enterTitle:     'Vào War Room',
    ...
    welcomeMsg:     'Chào mừng đến Babel War Room. Tất cả tin nhắn được dịch theo thời gian thực.',
  ...
  hi: { pageTitle: 'Babel War Room', headerSub: 'Babel War Room™ — रीयल-टाइम AI अनुवाद', enterTitle: 'War Room में प्रवेश करें', labelProjectId: 'प्रोजेक्ट ID', labelRole: 'मैं हूँ…', optEmployer: 'आपूर्तिकर्ता (चीनी बोलता है)', optEngineer: 'इंजीनियर (स्पेनिश बोलता है)', labelName: 'मेरा नाम', namePlaceholder: 'जैसे Terry या Juan', btnJoin: 'एन्क्रिप्टेड चैनल जॉइन करें', sidebarTitle: 'सक्रिय प्रोजेक्ट', lblProjectId: 'प्रोजेक्ट ID', lblCounterparty: 'प्रतिपक्ष', counterpartyEmployer: 'स्थानीय इंजीनियर (MX)', counterpartyEngineer: 'प्रोजेक्ट मैनेजर (CN)', waiting: 'प्रतीक्षा…', aiPmTitle: '🤖 AI-PM टूल (केवल नियोक्ता)', btnNudge: '🔔 ऑटो फॉलो-अप', btnReport: '📊 दैनिक रिपोर्ट', footerEncrypted: '🔒 एंड-टू-एंड एन्क्रिप्टेड', footerPowered: '⚡ Gemini 2.5 Flash द्वारा संचालित', chatTitle: 'इंजीनियरिंग सहयोग चैनल', liveTag: '● लाइव अनुवाद', exitBtn: 'डैशबोर्ड पर वापस', translating: 'अनुवाद हो रहा है…', send: 'भेजें', uploadTitle: 'कार्य प्रमाण अपलोड करें', welcomeMsg: 'Babel War Room में आपका स्वागत है। सभी संदेश रीयल-टाइम में अनुवादित होते हैं।', joinedMsg: (name, role) => `आप ${name} (${role}) के रूप में चैनल में शामिल हो गए`, placeholderEmployer: '请输入中文…', placeholderEngineer: 'Escribe tu mensaje en español…', labelMe: 'मैं', labelTrans: 'अनुवाद', offlinePhotoQueued: 'आप ऑफ़लाइन हैं — दोबारा कनेक्ट होने पर फ़ोटो अपलोड होगी।', pendingSync: 'सिंक लंबित', imageUnavailable: 'छवि उपलब्ध नहीं' },
  fr: { pageTitle: 'Babel War Room', headerSub: 'Babel War Room™ — Traduction IA en temps réel', enterTitle: 'Entrer dans la War Room', labelProjectId: 'ID de Projet', labelRole: 'Je suis le…', optEmployer: 'Fournisseur (parle chinois)', optEngineer: 'Ingénieur (parle espagnol)', labelName: 'Mon nom', namePlaceholder: 'ex. Terry ou Juan', btnJoin: 'Rejoindre le canal chiffré', sidebarTitle: 'Projet actif', lblProjectId: 'ID de Projet', lblCounterparty: 'Contrepartie', counterpartyEmployer: 'Ingénieur local (MX)', counterpartyEngineer: 'Chef de projet (CN)', waiting: 'En attente…', aiPmTitle: '🤖 Outils AI-PM (Employeur uniquement)', btnNudge: '🔔 Relance automatique', btnReport: '📊 Rapport quotidien', footerEncrypted: '🔒 Chiffrement de bout en bout', footerPowered: '⚡ Propulsé par Gemini 2.5 Flash', chatTitle: 'Canal de collaboration technique', liveTag: '● Traduction en direct', exitBtn: 'Retour au tableau de bord', translating: 'Traduction…', send: 'Envoyer', uploadTitle: 'Envoyer la preuve de travail', welcomeMsg: 'Bienvenue dans la Babel War Room. Tous les messages sont traduits en temps réel.', joinedMsg: (name, role) => `Vous avez rejoint le canal en tant que ${name} (${role})`, placeholderEmployer: '请输入中文…', placeholderEngineer: 'Escribe tu mensaje en español…', labelMe: 'Moi', labelTrans: 'Trad.', offlinePhotoQueued: 'Hors ligne — la photo sera envoyée à la reconnexion.', pendingSync: 'En attente de synchro', imageUnavailable: 'Image indisponible' },
  de: { pageTitle: 'Babel War Room', headerSub: 'Babel War Room™ — KI-Übersetzung in Echtzeit', enterTitle: 'War Room betreten', labelProjectId: 'Projekt-ID', labelRole: 'Ich bin der…', optEmployer: 'Lieferant (spricht Chinesisch)', optEngineer: 'Ingenieur (spricht Spanisch)', labelName: 'Mein Name', namePlaceholder: 'z.B. Terry oder Juan', btnJoin: 'Verschlüsseltem Kanal beitreten', sidebarTitle: 'Aktives Projekt', lblProjectId: 'Projekt-ID', lblCounterparty: 'Gegenpartei', counterpartyEmployer: 'Lokaler Ingenieur (MX)', counterpartyEngineer: 'Projektmanager (CN)', waiting: 'Warten…', aiPmTitle: '🤖 KI-PM-Tools (nur Auftraggeber)', btnNudge: '🔔 Auto-Follow-Up', btnReport: '📊 Tagesbericht erstellen', footerEncrypted: '🔒 Ende-zu-Ende-verschlüsselt', footerPowered: '⚡ Betrieben von Gemini 2.5 Flash', chatTitle: 'Technischer Kollaborationskanal', liveTag: '● Live-Übersetzung aktiv', exitBtn: 'Zum Dashboard', translating: 'Übersetze…', send: 'Senden', uploadTitle: 'Arbeitsnachweis hochladen', welcomeMsg: 'Willkommen im Babel War Room. Alle Nachrichten werden in Echtzeit übersetzt.', joinedMsg: (name, role) => `Sie sind dem Kanal als ${name} (${role}) beigetreten`, placeholderEmployer: '请输入中文…', placeholderEngineer: 'Escribe tu mensaje en español…', labelMe: 'Ich', labelTrans: 'Übers.', offlinePhotoQueued: 'Offline — das Foto wird beim Wiederverbinden hochgeladen.', pendingSync: 'Sync ausstehend', imageUnavailable: 'Bild nicht verfügbar' },
  ja: { pageTitle: 'Babel War Room', headerSub: 'Babel War Room™ — リアルタイムAI翻訳', enterTitle: 'War Roomに入室', labelProjectId: 'プロジェクトID', labelRole: '私は…', optEmployer: 'サプライヤー（中国語話者）', optEngineer: 'エンジニア（スペイン語話者）', labelName: '私の名前', namePlaceholder: '例：TerryまたはJuan', btnJoin: '暗号化チャンネルに参加', sidebarTitle: 'アクティブプロジェクト', lblProjectId: 'プロジェクトID', lblCounterparty: '相手方', counterpartyEmployer: 'ローカルエンジニア (MX)', counterpartyEngineer: 'プロジェクトマネージャー (CN)', waiting: '待機中…', aiPmTitle: '🤖 AI-PMツール（雇用者専用）', btnNudge: '🔔 自動フォローアップ', btnReport: '📊 日次報告書生成', footerEncrypted: '🔒 エンドツーエンド暗号化', footerPowered: '⚡ Gemini 2.5 Flash搭載', chatTitle: 'エンジニアリング協業チャンネル', liveTag: '● ライブ翻訳中', exitBtn: 'ダッシュボードへ', translating: '翻訳中…', send: '送信', uploadTitle: '作業証明をアップロード', welcomeMsg: 'Babel War Roomへようこそ。すべてのメッセージはリアルタイムで翻訳されます。', joinedMsg: (name, role) => `${name}（${role}）としてチャンネルに参加しました`, placeholderEmployer: '请输入中文…', placeholderEngineer: 'Escribe tu mensaje en español…', labelMe: '私', labelTrans: '翻訳', offlinePhotoQueued: 'オフライン — 写真は再接続時にアップロードされます。', pendingSync: '同期待ち', imageUnavailable: '画像を表示できません' },
  ko: { pageTitle: 'Babel War Room', headerSub: 'Babel War Room™ — 실시간 AI 번역', enterTitle: 'War Room 입장', labelProjectId: '프로젝트 ID', labelRole: '저는…', optEmployer: '공급업체 (중국어 사용)', optEngineer: '엔지니어 (스페인어 사용)', labelName: '내 이름', namePlaceholder: '예: Terry 또는 Juan', btnJoin: '암호화 채널 참가', sidebarTitle: '활성 프로젝트', lblProjectId: '프로젝트 ID', lblCounterparty: '상대방', counterpartyEmployer: '현지 엔지니어 (MX)', counterpartyEngineer: '프로젝트 매니저 (CN)', waiting: '대기 중…', aiPmTitle: '🤖 AI-PM 도구 (고용주 전용)', btnNudge: '🔔 자동 팔로업', btnReport: '📊 일일 보고서 생성', footerEncrypted: '🔒 엔드투엔드 암호화', footerPowered: '⚡ Gemini 2.5 Flash 기반', chatTitle: '엔지니어링 협업 채널', liveTag: '● 실시간 번역 중', exitBtn: '대시보드로 나가기', translating: '번역 중…', send: '전송', uploadTitle: '작업 증거 업로드', welcomeMsg: 'Babel War Room에 오신 것을 환영합니다. 모든 메시지가 실시간으로 번역됩니다.', joinedMsg: (name, role) => `${name} (${role}) 로 채널에 참가했습니다`, placeholderEmployer: '请输入中文…', placeholderEngineer: 'Escribe tu mensaje en español…', labelMe: '나', labelTrans: '번역', offlinePhotoQueued: '오프라인 — 사진은 다시 연결되면 업로드됩니다.', pendingSync: '동기화 대기 중', imageUnavailable: '이미지를 사용할 수 없음' },
};
