...
const DICT = {
  ...
  fr: {
    ...
    lead1:
      'Le recrutement de talents en automatisation à l’international échoue généralement sur l’un de ces deux points : vous ne pouvez pas vérifier qu’un mot-clé du CV correspond à une maîtrise réelle du contrôleur, du robot ou de la caméra précis que vous utilisez ; ou le volet financier d’une collaboration transfrontalière est trop risqué pour que l’une ou l’autre des parties s’engage. Cette page est la carte de nos réponses à ces deux problèmes — choisissez une spécialité, un secteur ou un intitulé de poste, et chaque chemin mène au même vivier vérifié.',
    lead2:
      'Chaque ingénieur de la plateforme réussit une évaluation technique pratique par IA avant de pouvoir être mis en relation, et peut obtenir la certification de la plateforme dans sa spécialité à trois niveaux — seuls les ingénieurs certifiés peuvent être affectés à votre projet. Le paiement s’effectue sous séquestre par jalons : les fonds sont retenus puis débloqués étape par étape à mesure que le travail est accepté, protégeant ainsi les deux parties, de part et d’autre de la frontière.',
    tracksTitle: 'Parcourir par spécialité',
    tracksIntro:
      'Quatre spécialités de certification. Chaque page de spécialité détaille ce que nous évaluons, ce que signifient les trois niveaux de certification et les fourchettes de tarifs par région.',
    viewTrack: 'Voir la spécialité →',
    industriesLabel: 'Par secteur :',
    rolesTitle: 'Recruter par intitulé de poste',
    rolesIntro:
      'Si vous raisonnez en intitulés de poste plutôt qu’en spécialités de certification, partez du poste — chaque page de poste relie l’intitulé à la bonne spécialité, aux compétences et au parcours de certification.',
