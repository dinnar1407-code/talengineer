...
const DICT = {
  ...
  fr: {
    ...
    sub: 'Parcourez les postes d’automatisation industrielle que vous pouvez pourvoir sur TalEngineer — regroupés par filière de certification, chacun avec une page dédiée couvrant les missions, les compétences, les tarifs régionaux et le parcours de certification associé à l’intitulé.',
    lead:
      'Un intitulé de poste et une filière de certification ne sont pas la même chose. Un intitulé comme « ingénieur SCADA » indique ce que fait une personne au quotidien ; une filière indique comment la plateforme l’évalue et la certifie. Ces pages relient les intitulés courants à nos quatre filières — PLC et contrôle-commande, Robotique, Vision industrielle et Électricité — afin que vous puissiez partir du poste que vous recrutez réellement.',
