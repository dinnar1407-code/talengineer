// ── /terms 页外壳文案字典（lib/i18n 架构 B，模块风格照抄 lib/i18n/rates.js）─────
//
// 来源：pages/terms.jsx 内联 UI 字典（en/zh 逐字节原样搬移，2026-07-24）。
// 页面外壳文案（九语）。正文本身来自 content/legal/terms.{lang}.md（九语已齐），
...
const DICT = {
  ...
  es: {
    ...
    crossLabel: 'Lea también cómo tratamos sus datos:',
    crossLink: 'Política de privacidad →',
  },
  vi: {
    kicker: 'Pháp lý',
    ...
    crossLabel: 'Cũng nên đọc cách chúng tôi xử lý dữ liệu của bạn:',
    crossLink: 'Chính sách quyền riêng tư →',
  },
  hi: {
    kicker: 'कानूनी',
    ...
    updated: 'अंतिम अपडेट',
    crossLabel: 'यह भी पढ़ें कि हम आपके डेटा को कैसे संभालते हैं:',
    crossLink: 'गोपनीयता नीति →',
  },
  fr: {
    kicker: 'Juridique',
    ...
    crossLabel: 'Lisez aussi comment nous traitons vos données :',
    crossLink: 'Politique de confidentialité →',
  },
  de: {
    kicker: 'Rechtliches',
    ...
    crossLabel: 'Lesen Sie auch, wie wir mit Ihren Daten umgehen:',
    crossLink: 'Datenschutzerklärung →',
  },
  ja: {
    kicker: '法務',
    draftBanner: '草案 — 法務レビュー待ち。本ページは現在の実務を誠実に記述していますが、最終的な法的文書ではありません。',
    updated: '最終更新',
    crossLabel: '当社のデータの取り扱いについてもご覧ください：',
    crossLink: 'プライバシーポリシー →',
  },
  ko: {
    kicker: '법률',
    draftBanner: '초안 — 법무 검토 대기 중. 이 페이지는 현재 관행을 있는 그대로 설명하지만 아직 최종 법적 문서가 아닙니다.',
    updated: '최종 업데이트',
    crossLabel: '당사가 데이터를 어떻게 처리하는지도 읽어보세요:',
    crossLink: '개인정보 처리방침 →',
  },
};
