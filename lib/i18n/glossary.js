...
const TERMS = {
  ...
  // 认证方向（track，四方向 PLC/robotics/vision/electrical 的统称概念，不是某个具体方向名）
  certificationTrack: {
    note: '认证方向的统称概念（"track"这个词本身，不是 PLC/robotics 这类具体方向名）。2026-07-25 补：fr 此前 filière/spécialité/parcours 三词混用，统一取站内数据层（lib/occupations.js/lib/hireMatrix.js）多数派 filière；parcours 保留给"认证流程/路径"语境（如 parcours de certification 指考证流程本身），不是 track 的同义词，两者不要混淆。其余 8 语沿用站内既有高频词（zh 方向/index.jsx 先例；es especialidad；vi chuyên môn；hi ट्रैक；de Fachrichtung；ja 専門分野；ko 분야）。',
    en: 'track', zh: '方向', es: 'especialidad', vi: 'chuyên môn',
    hi: 'ट्रैक', fr: 'filière', de: 'Fachrichtung', ja: '専門分野', ko: '분야',
  },
