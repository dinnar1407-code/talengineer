// ── 首页（pages/index.jsx）九语 UI 字典（lib/i18n 架构 B，模块风格照抄 lib/i18n/rates.js）──
//
// 来源：pages/index.jsx 内联 DICT（2026-07-24 逐字节原样搬移，零翻译零改写）。
// 渲染取值惯用式 `const d = { ...DICT.en, ...(DICT[lang] || {}) }` 保留在页面侧不动。
...
const DICT = {
  en: {
    ...
    // 页面 <title> / meta description（2026-07-25 九语元数据补齐）：metaTitle 不含品牌前缀
    // "Talengineer | "，由页面侧拼接；metaDescription 对应 og/twitter description 全部复用同一份。
    metaTitle: 'AI-Verified Industrial Automation Talent, Without Borders',
    metaDescription: 'Hire AI-verified PLC, SCADA, robotics, and electrical automation engineers — screened with a practical AI assessment and certified through platform exams. Milestone escrow protects both sides; an AI project manager works in nine languages.',
  },
  ...
  zh: {
    ...
    faqs: [
      { q: '聘请一位工业自动化工程师要花多少钱？', a: 'Talengineer 上的时薪从印度、越南的 $20–45/时到北美的 $85–140/时不等，取决于专业与资历。平台费用透明，没有中介加价——各地区的实时数据见我们的费率基准。' },
    ...
    metaTitle: 'AI 认证的工业自动化人才，跨越国界',
    metaDescription: '雇用经 AI 认证的 PLC、SCADA、机器人与电气自动化工程师——经实操型 AI 测评筛选、平台考证认证。里程碑托管保障双方权益，AI 项目经理支持九种语言协作。',
  },
  ...
  es: {
    ...
    cardHiringKicker: 'Estoy contratando', cardHiringTitle: 'Encuentre un ingeniero local verificado',
    cardHiringBody: 'Publique en cualquier idioma. Nuestra IA estandariza su especificación y preselecciona ingenieros evaluados por habilidad, región y tarifa.',
    cardHiringCta: 'Contratar un ingeniero →', cardHiringNote: 'Emparejado en 48 h en promedio',
    cardEngKicker: 'Soy ingeniero', cardEngTitle: 'Trabaje en todo el mundo. Cobre con seguridad.',
    cardEngBody: 'Supere una vez el evaluador técnico de IA y reciba proyectos afines de fabricantes de todo el mundo: el depósito en garantía asegura su pago.',
    cardEngCta: 'Únase como ingeniero →', cardEngNote: 'Postularse es gratis · conserva la mayor parte de cada $',
    // Stats
    stats: [
    ...
    // Categories
    catKicker: 'Explore por especialidad', catH2: 'Todas las disciplinas de la automatización industrial', catAll: 'Todas las especialidades →',
    ...
    employerSteps: [
      { title: 'Publique su proyecto en cualquier idioma', body: 'Nuestra IA convierte su especificación en un alcance, hitos y requisitos de habilidad estandarizados.' },
      { title: 'Encuentre ingenieros verificados', body: 'Preselecciones ordenadas por puntuación de evaluación, región, tarifa y disponibilidad presencial.' },
      { title: 'Financie los hitos en depósito en garantía', body: 'El dinero se libera solo cuando usted aprueba cada entrega. Cero riesgo por adelantado.' },
    ...
    engineerSteps: [
      { title: 'Cree su perfil en minutos', body: 'Enumere sus plataformas, certificaciones, sectores y tarifa, en su propio idioma.' },
      { title: 'Supere el evaluador técnico de IA', body: 'Una prueba práctica de habilidades de PLC, SCADA y robótica: la insignia en la que confían los clientes.' },
      { title: 'Emparéjese con proyectos reales', body: 'Trabajo local y remoto de fabricantes e integradores de todo el mundo, sin guerras de pujas.' },
      { title: 'Cobre a tiempo, siempre', body: 'Los hitos con depósito en garantía aseguran su pago antes de empezar.' },
    ],
    // Featured
    ...
    demoEngineers: [
      { id: 'demo-1', initials: 'MN', name: 'Minh N.', loc: '🇻🇳 Ciudad Ho Chi Minh', chips: ['Siemens TIA Portal', 'WinCC', 'Profinet'], bio: 'Lideró la migración de PLC de 3 líneas de proveedores tier-1 del sector automotriz; puesta en marcha FAT/SAT en todo el Sudeste Asiático.', rate: '$38/hr', ratingLine: '★ 4.9 (27 trabajos)' },
      { id: 'demo-2', initials: 'DR', name: 'Diego R.', loc: '🇲🇽 Monterrey', chips: ['Fanuc Robotics', 'Studio 5000', 'Machine Vision'], bio: 'Integrador de celdas de soldadura robotizada; más de 40 celdas Fanuc puestas en marcha para OEM de EE. UU. y México.', rate: '$52/hr', ratingLine: '★ 5.0 (34 trabajos)' },
      { id: 'demo-3', initials: 'PK', name: 'Priya K.', loc: '🇮🇳 Pune', chips: ['Ignition SCADA', 'OPC UA', 'Python'], bio: 'Certificada Ignition Gold; construyó SCADA para toda la planta en instalaciones farmacéuticas y de alimentos y bebidas.', rate: '$34/hr', ratingLine: '★ 4.8 (19 trabajos)' },
    ],
    // Rate benchmarks
    rateKicker: 'Datos de mercado en vivo', rateH2: 'Conozca la tarifa justa antes de contratar',
    rateBody: 'Referencias de tarifas por hora en tiempo real, por región y especialidad, a partir de perfiles de ingenieros activos. Presupueste con confianza: sin conjeturas ni sobreprecios de agencia.',
    ...
    trust: [
      ...
      { emoji: '💰', title: 'Depósito en garantía por hitos', body: 'Los fondos se guardan de forma segura y se liberan solo cuando usted aprueba cada entrega. Ambas partes quedan protegidas.' },
    ...
    faqs: [
      { q: '¿Cuánto cuesta contratar a un ingeniero de automatización industrial?', a: 'Las tarifas por hora en Talengineer van desde $20–45/hr en India y Vietnam hasta $85–140/hr en Norteamérica, según la especialidad y la experiencia. Las comisiones de la plataforma son transparentes y no hay sobreprecios de agencia; consulte nuestras referencias de tarifas en vivo para ver las cifras actuales por región.' },
      ...
      { q: '¿Cómo me protege el depósito en garantía por hitos?', a: 'Usted financia cada hito del proyecto en depósito en garantía antes de que empiece el trabajo. Los fondos se liberan solo cuando usted aprueba la entrega. Si surge una disputa, nuestro equipo de resolución revisa la especificación del hito y el trabajo entregado antes de mover cualquier dinero.' },
      { q: '¿Pueden los ingenieros trabajar en mis instalaciones?', a: 'Sí. Muchos proyectos combinan el desarrollo remoto con la puesta en marcha in situ. Filtre ingenieros por ciudad y radio de desplazamiento: contamos con talento local verificado en Norteamérica, Latinoamérica, Europa, Vietnam, India y más.' },
      ...
      { q: '¿Cuánto cuesta a los ingenieros unirse?', a: 'Unirse y superar el evaluador técnico de IA es gratis. Talengineer cobra una pequeña comisión de servicio solo sobre los hitos pagados: usted conserva la gran mayoría de cada dólar que gana.' },
    ],
    // Resources
    ...
    // Final CTA
    ctaH2: 'Su próximo proyecto de automatización empieza aquí',
    ctaSub: 'Publique un proyecto en cualquier idioma, o únase a nuestro grupo fundador de ingenieros verificados.',
    ctaPost: 'Publicar un proyecto — Gratis', ctaApply: 'Postularme como ingeniero',
    metaTitle: 'Talento en Automatización Industrial Verificado por IA, Sin Fronteras',
    metaDescription: 'Contrate ingenieros de automatización en PLC, SCADA, robótica y eléctrica verificados por IA, evaluados con una prueba práctica de IA y certificados mediante exámenes de la plataforma. El depósito en garantía por hitos protege a ambas partes; un gestor de proyectos con IA trabaja en nueve idiomas.',
  },
  ...
  vi: {
    ...
    metaTitle: 'Nhân Tài Tự Động Hóa Công Nghiệp Được AI Xác Minh, Không Biên Giới',
    metaDescription: 'Thuê kỹ sư tự động hóa PLC, SCADA, robot và điện đã được AI xác minh — được sàng lọc bằng bài đánh giá AI thực hành và cấp chứng chỉ qua các kỳ thi trên nền tảng. Ký quỹ theo cột mốc bảo vệ cả hai bên; quản lý dự án AI hoạt động bằng chín ngôn ngữ.',
  },
  ...
  hi: {
    ...
    metaTitle: 'AI-सत्यापित औद्योगिक ऑटोमेशन प्रतिभा, बिना सीमाओं के',
    metaDescription: 'AI-सत्यापित PLC, SCADA, रोबोटिक्स और इलेक्ट्रिकल ऑटोमेशन इंजीनियर नियुक्त करें — एक व्यावहारिक AI मूल्यांकन से जाँचे गए और प्लेटफ़ॉर्म परीक्षाओं से प्रमाणित। माइलस्टोन एस्क्रो दोनों पक्षों की सुरक्षा करता है; एक AI प्रोजेक्ट मैनेजर नौ भाषाओं में काम करता है।',
  },
  ...
  fr: {
    ...
    heroSub: "Ingénieurs PLC, SCADA, robotique et génie électrique — sélectionnés par une évaluation pratique par IA, certifiés par les examens de la plateforme, et pilotés en neuf langues.",
    ...
    // Stats
    stats: [
      { num: '4', label: 'Filières de certification' },
    ...
    categories: [
      ...
      { emoji: '🧰', name: 'Mise en service et interventions sur site', tools: 'Démarrage sur site, FAT/SAT, rétrofit et dépannage', count: 241, rate: 59 },
    ],
    // How it works
    ...
    employerSteps: [
      { title: "Publiez votre projet dans n’importe quelle langue", body: "Notre IA structure votre cahier des charges en périmètre, jalons et exigences de compétences standardisés." },
      ...
      { title: "Financez les jalons sous séquestre", body: "L’argent n’est libéré que lorsque vous approuvez chaque livrable. Aucun risque initial." },
    ...
    engineerSteps: [
      ...
      { title: "Recevez de vrais projets qui vous correspondent", body: "Travail local et à distance auprès d’OEM et d’intégrateurs du monde entier — sans guerre des prix." },
      { title: "Soyez payé à temps, à chaque fois", body: "Les jalons sous séquestre garantissent votre paiement avant même que vous ne commenciez." },
    ],
    // Featured
    ...
    faqs: [
      ...
      { q: "Que coûte l’inscription pour un ingénieur ?", a: "S’inscrire et réussir l’évaluateur technique IA est gratuit. Talengineer ne prélève que de modestes frais de service sur les jalons payés — vous gardez la grande majorité de chaque dollar gagné." },
    ],
    // Resources
    ...
    metaTitle: 'Talents en automatisation industrielle vérifiés par IA, sans frontières',
    metaDescription: "Recrutez des ingénieurs en automatisation PLC, SCADA, robotique et génie électrique vérifiés par IA — sélectionnés par une évaluation pratique par IA et certifiés par les examens de la plateforme. Le séquestre par jalon protège les deux parties ; un chef de projet IA travaille en neuf langues.",
  },
  ...
  de: {
    ...
    metaTitle: 'KI-verifizierte Industrieautomatisierungstalente, ohne Grenzen',
    metaDescription: 'Engagieren Sie KI-verifizierte PLC-, SCADA-, Robotik- und Elektroautomatisierungsingenieure — geprüft mit einem praxisnahen KI-Assessment und zertifiziert durch Plattformprüfungen. Meilenstein-Treuhand schützt beide Seiten; ein KI-Projektmanager arbeitet in neun Sprachen.',
  },
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: 'エンジニアの参加費用はいくらですか？', a: '参加とAI技術スクリーナーの合格は無料です。Talengineerは支払い済みのマイルストーンにのみ少額のサービス料を請求します——稼いだ報酬の大半はあなたのものです。' },
    ],
    // Resources
    ...
    ctaSub: 'どの言語でもプロジェクトを投稿するか、私たちの最初の検証済みエンジニアグループに参加しましょう。',
    ctaPost: 'プロジェクトを投稿——無料', ctaApply: 'エンジニアとして応募',
    metaTitle: 'AI認証の産業オートメーション人材、国境を越えて',
    metaDescription: 'AI検証済みのPLC、SCADA、ロボティクス、電気オートメーションエンジニアを採用——実践的なAIアセスメントで審査し、プラットフォーム試験で認定。マイルストーンエスクローが双方を保護し、AIプロジェクトマネージャーが9言語で対応します。',
  },
  ...
  ko: {
    ...
    rateBody: '지역 및 전문 분야별 실시간 시간당 요율 벤치마크로, 활동 중인 엔지니어 프로필에서 수집합니다. 추측도, 부풀려진 에이전시 마진도 없이 자신 있게 예산을 세우세요.',
    ...
    faqs: [
      { q: '산업 자동화 엔지니어를 채용하는 데 비용이 얼마나 드나요?', a: 'Talengineer의 시간당 요율은 인도와 베트남의 $20–45/hr부터 북미의 $85–140/hr까지 전문 분야와 경력에 따라 다릅니다. 플랫폼 수수료는 투명하며 에이전시 마진이 없습니다 — 지역별 최신 수치는 실시간 요율 벤치마크에서 확인하세요.' },
    ...
    resources: [
      { tag: '채용 가이드', title: '2026년 PLC 프로그래머 시간당 요율: 지역별 분석', teaser: '여섯 개 지역에서 Siemens와 Rockwell 전문성의 비용, 그리고 오프쇼어가 합리적인 시점.', href: '/playbook/plc-programmer-hourly-rates-2026' },
    ...
    metaTitle: 'AI 검증 산업 자동화 인재, 국경 없이',
    metaDescription: 'AI로 검증된 PLC, SCADA, 로보틱스, 전기 자동화 엔지니어를 채용하세요 — 실무형 AI 평가로 선별하고 플랫폼 시험으로 인증합니다. 마일스톤 에스크로가 양측을 보호하며, AI 프로젝트 매니저가 9개 언어로 지원합니다.',
  },
};
