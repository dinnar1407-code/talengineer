    ...
    fr: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Une évaluation pratique par IA lors de l’intégration établit le score vérifié sur le profil d’un ingénieur, avec en plus la certification dans la filière Électricité à trois niveaux (L1–L3) — de la réalisation d’implantations d’armoires standard sous encadrement jusqu’à la conception de la distribution électrique et de systèmes électriques complexes. Les examens sont notés par IA et vérifiés par un administrateur avant délivrance du certificat, et seuls les ingénieurs détenant une certification de plateforme valide peuvent être officiellement affectés à des projets — dans la filière Électricité, si vous l’exigez.",
        },
      ],
    },
    de: {
