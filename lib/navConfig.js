...
const LINKS = {
  ...
  compare: {
    key: 'compare',
    href: '/compare',
    label: L9('Compare Options', '方案对比', 'Comparativas', 'So sánh lựa chọn', 'विकल्पों की तुलना', 'Comparatifs', 'Optionen vergleichen', '選択肢の比較', '선택지 비교'),
  },
  playbook: {
    key: 'playbook',
    href: '/playbook',
...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      LINKS.compare, // 决策期问题（该走中介还是平台/和 XX 有什么区别），排在内容型资源之前
      LINKS.playbook,
      LINKS.caseStudies,
      LINKS.guideMexico,
      LINKS.guideVietnam,
