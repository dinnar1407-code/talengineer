...
// 白名单：只认识这两份文档、九种站点语言（2026-07-24 九语铺开：privacy/terms
// 正文补齐 es/vi/hi/fr/de/ja/ko，与 lib/i18n glossary.js 九语口径一致）。
 ...
 * 找不到文件或参数不合法时返回 null（页面侧对非 en 语言用 || en 回退，en 缺失则构建期抛错）。
 *
 * @param {string} doc 'privacy' | 'terms'
 * @param {string} lang 'en' | 'zh' | 'es' | 'vi' | 'hi' | 'fr' | 'de' | 'ja' | 'ko'
