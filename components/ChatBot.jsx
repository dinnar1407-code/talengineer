...
const DICT = {
  en: {
    ...
    financeReply: (amt) => `<b>💳 AI-CFO Report:</b><br/>You have $${amt || '1,500'} in locked escrow.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Go to Finance Dashboard</a>`,
    talentReply:  '<b>🛡️ Ghost HR Report:</b><br/>3 senior PLC engineers are ready to view.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">View Engineers</a>',
  ...
  zh: {
    ...
    financeReply: () => '<b>💳 AI-CFO 资金报告：</b><br/>长官，托管账户中有 $1,500 处于锁定状态。<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">进入财务大盘</a>',
    talentReply: '<b>🛡️ Ghost HR 汇报：</b><br/>3 名高级 PLC 专家正待您查看。<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">查看最新工程师</a>',
  ...
  es: {
    ...
    financeReply: () => '<b>💳 Informe AI-CFO:</b><br/>Tienes $1,500 bloqueados en garantía.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Ir al Panel Financiero</a>',
    talentReply: '<b>🛡️ Informe Ghost HR:</b><br/>3 ingenieros PLC senior listos para revisar.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Ver Ingenieros</a>',
  ...
  vi: {
    ...
    financeReply: () => '<b>💳 Báo cáo AI-CFO:</b><br/>Bạn có $1,500 đang bị khóa trong ký quỹ.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Xem Bảng Tài Chính</a>',
    talentReply: '<b>🛡️ Báo cáo Ghost HR:</b><br/>3 kỹ sư PLC cấp cao sẵn sàng để xem.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Xem Kỹ Sư</a>',
  ...
  hi: {
    ...
    financeReply: () => '<b>💳 AI-CFO रिपोर्ट:</b><br/>आपके एस्क्रो में $1,500 लॉक है।<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">वित्त डैशबोर्ड देखें</a>',
    talentReply: '<b>🛡️ Ghost HR रिपोर्ट:</b><br/>3 वरिष्ठ PLC इंजीनियर देखने के लिए तैयार हैं।<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">इंजीनियर देखें</a>',
  ...
  fr: {
    ...
    financeReply: () => '<b>💳 Rapport AI-CFO :</b><br/>Vous avez 1 500 $ bloqués en séquestre.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Tableau de bord financier</a>',
    talentReply: '<b>🛡️ Rapport Ghost HR :</b><br/>3 ingénieurs PLC seniors prêts à consulter.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Voir les ingénieurs</a>',
  ...
  de: {
    ...
    financeReply: () => '<b>💳 KI-CFO Bericht:</b><br/>Sie haben 1.500 $ im Treuhandkonto gesperrt.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Zum Finanz-Dashboard</a>',
    talentReply: '<b>🛡️ Ghost HR Bericht:</b><br/>3 erfahrene SPS-Ingenieure bereit zur Ansicht.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">Ingenieure ansehen</a>',
  ...
  ja: {
    ...
    loading:  '🌾 リクエストを処理中です…',
    financeReply: () => '<b>💳 AI-CFOレポート：</b><br/>エスクローに $1,500 がロック中です。<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">財務ダッシュボードへ</a>',
    talentReply: '<b>🛡️ Ghost HRレポート：</b><br/>上級PLCエンジニア3名が確認待ちです。<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">エンジニアを見る</a>',
  ...
  ko: {
    ...
    loading:  '🌾 요청을 처리 중입니다…',
    financeReply: () => '<b>💳 AI-CFO 보고서:</b><br/>에스크로에 $1,500이 잠겨 있습니다.<br/><a href="/finance" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">재무 대시보드로 이동</a>',
    talentReply: '<b>🛡️ Ghost HR 보고서:</b><br/>시니어 PLC 엔지니어 3명이 확인 대기 중입니다.<br/><a href="/talent" style="display:inline-block;margin-top:8px;padding:6px 12px;background:var(--primary);color:#fff;border-radius:6px;">엔지니어 보기</a>',
