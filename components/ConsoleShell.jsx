...
const DICT = {
  ...
  es: {
    ...
    notifications: 'Notificaciones', markAllRead: 'Marcar todo leído', notifEmpty: 'Sin notificaciones', loading: 'Cargando…',
    demoData: 'Datos de demo', settings: 'Configuración', logout: 'Cerrar sesión',
  },
  vi: {
    ...
    notifications: 'Thông báo', markAllRead: 'Đánh dấu đã đọc tất cả', notifEmpty: 'Không có thông báo', loading: 'Đang tải…',
    demoData: 'Dữ liệu demo', settings: 'Cài đặt', logout: 'Đăng xuất',
  },
  hi: {
    ...
    notifications: 'सूचनाएं', markAllRead: 'सभी को पढ़ा हुआ चिह्नित करें', notifEmpty: 'कोई सूचना नहीं', loading: 'लोड हो रहा है…',
    demoData: 'डेमो डेटा', settings: 'सेटिंग्स', logout: 'साइन आउट',
  },
  fr: {
    ...
    notifications: 'Notifications', markAllRead: 'Tout marquer comme lu', notifEmpty: 'Aucune notification', loading: 'Chargement…',
    demoData: 'Données de démo', settings: 'Paramètres', logout: 'Déconnexion',
  },
  de: {
    ...
    notifications: 'Benachrichtigungen', markAllRead: 'Alle als gelesen markieren', notifEmpty: 'Keine Benachrichtigungen', loading: 'Wird geladen…',
    demoData: 'Demodaten', settings: 'Einstellungen', logout: 'Abmelden',
  },
  ja: {
    ...
    notifications: '通知', markAllRead: 'すべて既読にする', notifEmpty: '通知はありません', loading: '読み込み中…',
    demoData: 'デモデータ', settings: '設定', logout: 'サインアウト',
  },
  ko: {
    ...
    notifications: '알림', markAllRead: '모두 읽음 표시', notifEmpty: '알림 없음', loading: '불러오는 중…',
    demoData: '데모 데이터', settings: '설정', logout: '로그아웃',
  },
};
